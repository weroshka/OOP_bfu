...
int main() {
    ...
    std::cout << "В виде строки разрезаем куб в точке x=0 " << std::endl;

    for (int value : cube.GetValuesX(0)) {
        std::cout << value << " ";
    }

    std::cout<<std::endl<<"В виде прямогульника разрезаем куб в x=0 "<<std::endl;
    ...
    std::cout<<"В виде строки разрезаем куб в y=2 "<<std::endl;

    for (int value : cube.GetValuesY(2)) {
        std::cout << value << " ";
    }

    std::cout<<std::endl<<"Разрезаем в виде прямоугольника куб в y=2 "<<std::endl;
    ...
    std::cout<<"Разрезаем в виде строки куб в z = 1 "<<std::endl;

    for (int value : cube.GetValuesZ(1)) {
        std::cout << value << " ";
    }

    std::cout<<std::endl<<"Разрезаем в виде прямоугольника куб в z=1 "<<std::endl;
    ...
    //утанавливаем новые значения в точке x=0
    ...
    std::cout<<std::endl<<"После заполнения 1 срез куба в y = 2 - в виде прямоугольника"<<std::endl;
